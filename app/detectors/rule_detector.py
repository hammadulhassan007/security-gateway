...
# Aapke purane phrases ki list + Urdu aur Korean attacks
ATTACK_KEYWORDS = {
    # English
...
def calc_rule_risk(text: str) -> float:
    ...
    # Obfuscation handle karne ke liye (spaces aur punctuation remove kar ke check karna)
